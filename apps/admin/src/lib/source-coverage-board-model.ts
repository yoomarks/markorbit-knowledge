...
export function deriveSourceCoverageBoundary(
  ...
  missingExpectedArtifactKinds.forEach((kind) => reasons.add(`EXPECTED_ARTIFACT_KIND_MISSING:${kind}`));
...
export function latestEvidenceTimestamp(...values: Array<string | null | undefined>): string | null {
