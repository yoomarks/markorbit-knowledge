  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-40 inline-flex items-center gap-2 rounded-2xl bg-slate-950 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-slate-950/20"
      >
        <FileUp size={17} />
