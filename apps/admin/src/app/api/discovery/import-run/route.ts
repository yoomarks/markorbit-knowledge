...
function optionalCategory(value: unknown, field: string): SourceCategory | undefined {
  if (value === undefined || value === null || value === "") return undefined;
...
function optionalAuthority(value: unknown, field: string): AuthorityLevel | undefined {
  if (value === undefined || value === null || value === "") return undefined;
...
function intakeDefaults(value: unknown, prefix: string): DiscoveryIntakeDefaults | undefined {
  if (value === undefined || value === null) return undefined;
...
function importEntries(value: unknown): ImportEntry[] {
...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json({ summary, items }, { status: 201 });
  } catch (error) {
