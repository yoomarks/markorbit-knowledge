...
export class SourceIntelligenceService {
  ...
  historyV2(sourceId: string, limit = 20): SourceIntelligenceObservationHistoryV2 {
    const projected = this.dependencies.intelligence
      .listForSource(sourceId, limit)
      .map(projectSourceIntelligenceV2);
    return buildSourceIntelligenceObservationHistoryV2(sourceId, projected);
  }
