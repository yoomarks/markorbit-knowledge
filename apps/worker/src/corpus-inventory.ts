...
export const GOLDEN_CORPORA: readonly CorpusDefinition[] = [
  ...
  },
  {
    ...
    domains: [
      {
        id: "filing",
        label: "Filing and application basics",
        matchAny: ["filing", "apply", "application"],
      },
      {
        id: "examination",
        label: "Examination and Office Action guidance",
        matchAny: ["examination", "office action", "examining"],
      },
      {
        id: "tmep",
        label: "TMEP current and published history",
        matchAny: ["tmep", "trademark manual of examining procedure"],
      },
      {
        id: "examination-guides",
        label: "Examination Guides",
        matchAny: ["examination guide", "exam guide"],
      },
      {
        id: "registration",
        label: "Registration guidance",
        matchAny: ["registration", "register"],
      },
      {
        id: "post-registration",
        label: "Post-registration and maintenance",
        matchAny: [
          "post-registration",
      ...
      {
        id: "ttab-tbmp",
        label: "TTAB and TBMP practice materials",
        matchAny: ["ttab", "tbmp", "trial and appeal board"],
      },
      {
        id: "madrid",
        label: "Madrid Protocol materials",
        matchAny: ["madrid", "66(a)", "section 66"],
      },
      {
        id: "ownership-assignments",
        label: "Ownership and assignments",
        matchAny: ["assignment", "ownership", "assignments"],
      },
      {
        id: "forms-systems",
        label: "Forms and systems guidance",
        matchAny: ["trademark center", "teas", "form", "forms"],
      },
      { id: "faqs", label: "Trademark FAQs", matchAny: ["faq", "frequently asked"] },
      {
        id: "training-video",
        label: "Videos, webinars and training",
        matchAny: ["video", "webinar", "training"],
      },
      {
        id: "news-policy",
        label: "News, alerts, policy and rule changes",
        matchAny: ["news", "alert", "policy", "rule change", "federal register"],
      },
    ],
  },
  {
    ...
    domains: [
      {
        id: "madrid-procedure",
        label: "Madrid System procedures",
        matchAny: ["madrid system", "madrid procedure", "madrid"],
      },
      {
        id: "legal-texts",
        label: "Madrid legal texts and rules",
        matchAny: ["legal text", "regulations", "madrid protocol"],
      },
      {
        id: "members",
        label: "Members, profiles and declarations",
        matchAny: ["member profile", "contracting party", "declaration"],
      },
      ...
      { id: "nice", label: "Nice Classification", matchAny: ["nice classification", "nice"] },
      {
        ...
        matchAny: ["vienna classification", "vienna"],
      },
      {
        id: "global-brand-database",
        label: "Global Brand Database",
        matchAny: ["global brand database", "brand database"],
      },
      { id: "madrid-monitor", label: "Madrid Monitor", matchAny: ["madrid monitor"] },
      {
        id: "guides-help",
        label: "Guides and help resources",
        matchAny: ["guide", "help", "how to"],
      },
...
export function auditCorpusCoverage(
  ...
  const scoped = candidates.filter((candidate) =>
    hostMatches(candidate, definition.discoveryHosts),
  );
