...
export function summarizeCnipaNetLog(raw: Buffer): CnipaNetLogSummary {
  ...
  return {
    ...
    limitations: [
      ...
      "Only fixed candidate paths are eligible for output; this is not an endpoint-migration detector.",
      "Request payload schema, response envelope, identity and coverage are NOT VERIFIED.",
      "No matching event does not prove an endpoint is absent, migrated or inaccessible.",
