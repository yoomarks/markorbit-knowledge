...
const authoritySets = [
  ...
  ["ID", DJKI_ID_SOURCE_COVERAGE_TARGETS, ["dgip.go.id"]],
  ["VN", IPVN_VN_SOURCE_COVERAGE_TARGETS, ["ipvietnam.gov.vn"]],
  ["LK", NIPO_LK_SOURCE_COVERAGE_TARGETS, ["nipo.gov.lk", "lk.wipo.net"]],
  ["TH", DIP_TH_SOURCE_COVERAGE_TARGETS, ["ipthailand.go.th"]],
  ["ZA", CIPC_ZA_SOURCE_COVERAGE_TARGETS, ["cipc.co.za"]],
  ["CL", INAPI_CL_SOURCE_COVERAGE_TARGETS, ["inapi.cl"]],
  ["CO", SIC_CO_SOURCE_COVERAGE_TARGETS, ["sic.gov.co"]],
  ...
  ["IR", IPC_IR_SOURCE_COVERAGE_TARGETS, ["ssaa.ir", "wipo.int"]],
  ["PK", IPO_PK_SOURCE_COVERAGE_TARGETS, ["ipo.gov.pk", "wipo.int"]],
  ["IQ", MOIM_IQ_SOURCE_COVERAGE_TARGETS, ["industry.gov.iq", "ur.gov.iq", "wipo.int"]],
  ["NL", BOIP_NL_SOURCE_COVERAGE_TARGETS, ["boip.int", "wipo.int"]],
  ["BE", BOIP_BE_SOURCE_COVERAGE_TARGETS, ["boip.int", "wipo.int"]],
  ["AL", DPPI_AL_SOURCE_COVERAGE_TARGETS, ["dppi.gov.al"]],
  ...
  ["LB", MOET_LB_SOURCE_COVERAGE_TARGETS, ["economy.gov.lb"]],
...
describe("priority national trademark source coverage", () => {
  it("ships explicit, official, unique coverage for one hundred two priority national offices", () => {
    expect(PRIORITY_NATIONAL_SOURCE_COVERAGE_TARGETS).toHaveLength(780);
