...
export const CNIPA_SOURCE_COVERAGE_TARGETS = [
  ...
  target(CNIPA, {
    ...
    canonicalUri: "https://sbj.cnipa.gov.cn/trademark-query",
    mode: "MIXED",
  ...
  target(CNIPA, {
    ...
    entrypoints: [
      { uri: "https://sbj.cnipa.gov.cn/shbjfzn/index.html", label: "Trademark fee payment guide" },
...
export const UANIPIO_UA_SOURCE_COVERAGE_TARGETS = [
  target(UANIPIO_UA, {
    ...
    verificationEvidenceUri: "https://portal.nipo.gov.ua/uk/discovery-obj/tm-pro-torhovelni-marky",
    notes:
      "Current NIPO trademark landing page linking registration, search, fees, legislation and related official services.",
  }),
  target(UANIPIO_UA, {
    ...
    notes:
      "Official electronic application system explicitly supporting signs for goods and services (trade marks).",
  }),
  target(UANIPIO_UA, {
    ...
    expectedArtifactKinds: ["HTML", "JSON"],
    verificationEvidenceUri:
      "https://portal.nipo.gov.ua/discovery-obj/tm-poshuk-zareiestrovanykh-tm",
    notes:
      "Official SIS search for industrial-property objects, including trademark applications and registrations.",
  }),
  target(UANIPIO_UA, {
    ...
    expectedArtifactKinds: ["HTML", "MARKDOWN", "PDF"],
    verificationEvidenceUri:
      "https://portal.nipo.gov.ua/uk/discovery-obj/tm-derzhavne-myto-i-zbory",
    notes:
      "Current trademark fee and state-duty page, reflecting the applicable fee order and payment details.",
  }),
  target(UANIPIO_UA, {
    ...
    notes:
      "Official Ukrainian Nice Classification information system for the 13th edition, 2026 version, effective from 1 January 2026.",
  }),
  target(UANIPIO_UA, {
    ...
    notes:
      "Official NIPO trademark legal framework page linking the Trademark Law, current filing/examination rules and fee regulation.",
  }),
  target(UANIPIO_UA, {
    ...
    notes:
      "Official NIPO subordinate-regulation index listing the current trademark application, international-registration and examination rules approved by Order No. 19889 of 6 August 2024.",
  }),
  target(UANIPIO_UA, {
    ...
    notes:
      "Official Appeal Chamber procedure for objections to NIPO decisions, invalidation applications and well-known trademark proceedings.",
  }),
  target(UANIPIO_UA, {
    ...
    notes:
      "Official SIS bulletin surface for industrial-property publication records; retained as a change signal rather than a foundational retrieval target.",
  }),
] satisfies readonly SourceCoverageTarget[];
...
export const EIPA_EG_SOURCE_COVERAGE_TARGETS = [
  ...
  target(EIPA_EG, {
    ...
    family: "LEGAL_TEXTS",
    displayName:
      "Egypt Law No. 82 of 2002 on Intellectual Property Rights – Current WIPO Lex Version",
