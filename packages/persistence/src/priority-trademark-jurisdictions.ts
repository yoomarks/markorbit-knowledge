...
const PRIORITY_TRADEMARK_JURISDICTION_SEEDS = [
  ...
  ["NL", "Netherlands", "EUROPE", "P0", "CURATED", "REGIONAL"],
  ["IR", "Iran", "MIDDLE_EAST_NORTH_AFRICA", "P0", "CURATED", "NATIONAL"],
  ...
  ["PK", "Pakistan", "ASIA_PACIFIC", "P1", "CURATED", "NATIONAL"],
  ["BE", "Belgium", "EUROPE", "P1", "CURATED", "REGIONAL"],
  ...
  ["IQ", "Iraq", "MIDDLE_EAST_NORTH_AFRICA", "P2", "CURATED", "NATIONAL"],
  ...
  ["EC", "Ecuador", "LATIN_AMERICA_CARIBBEAN", "P2", "CURATED", "NATIONAL"],
  ["VE", "Venezuela", "LATIN_AMERICA_CARIBBEAN", "P2", "CURATED", "NATIONAL"],
  ["UY", "Uruguay", "LATIN_AMERICA_CARIBBEAN", "P2", "CURATED", "NATIONAL"],
  ["GT", "Guatemala", "LATIN_AMERICA_CARIBBEAN", "P2", "CURATED", "NATIONAL"],
  ["CR", "Costa Rica", "LATIN_AMERICA_CARIBBEAN", "P2", "CURATED", "NATIONAL"],
  ["PA", "Panama", "LATIN_AMERICA_CARIBBEAN", "P2", "CURATED", "NATIONAL"],
  ["DO", "Dominican Republic", "LATIN_AMERICA_CARIBBEAN", "P2", "CURATED", "NATIONAL"],
  ["ET", "Ethiopia", "SUB_SAHARAN_AFRICA", "P2", "CURATED", "NATIONAL"],
  ["IS", "Iceland", "EUROPE", "P3", "CURATED", "NATIONAL"],
  ["MT", "Malta", "EUROPE", "P3", "CURATED", "NATIONAL"],
  ["AL", "Albania", "EUROPE", "P3", "CURATED", "NATIONAL"],
  ["BA", "Bosnia and Herzegovina", "EUROPE", "P3", "CURATED", "NATIONAL"],
  ["MK", "North Macedonia", "EUROPE", "P3", "CURATED", "NATIONAL"],
  ["BY", "Belarus", "EUROPE", "P3", "CURATED", "NATIONAL"],
  ["MN", "Mongolia", "ASIA_PACIFIC", "P3", "CURATED", "NATIONAL"],
  ["KH", "Cambodia", "ASIA_PACIFIC", "P3", "CURATED", "NATIONAL"],
  ["LA", "Lao PDR", "ASIA_PACIFIC", "P3", "CURATED", "NATIONAL"],
  ["MM", "Myanmar", "ASIA_PACIFIC", "P3", "CURATED", "NATIONAL"],
  ["BN", "Brunei Darussalam", "ASIA_PACIFIC", "P3", "CURATED", "NATIONAL"],
  ["LB", "Lebanon", "MIDDLE_EAST_NORTH_AFRICA", "P3", "CURATED", "NATIONAL"],
  ["PY", "Paraguay", "LATIN_AMERICA_CARIBBEAN", "P3", "CURATED", "NATIONAL"],
  ["BO", "Bolivia", "LATIN_AMERICA_CARIBBEAN", "P3", "CURATED", "NATIONAL"],
  ["HN", "Honduras", "LATIN_AMERICA_CARIBBEAN", "P3", "CURATED", "NATIONAL"],
  ["SV", "El Salvador", "LATIN_AMERICA_CARIBBEAN", "P3", "CURATED", "NATIONAL"],
  ["CU", "Cuba", "LATIN_AMERICA_CARIBBEAN", "P3", "CURATED", "NATIONAL"],
  ["JM", "Jamaica", "LATIN_AMERICA_CARIBBEAN", "P3", "CURATED", "NATIONAL"],
  ["TT", "Trinidad and Tobago", "LATIN_AMERICA_CARIBBEAN", "P3", "CURATED", "NATIONAL"],
  ["TZ", "Tanzania", "SUB_SAHARAN_AFRICA", "P3", "CURATED", "NATIONAL"],
  ["AO", "Angola", "SUB_SAHARAN_AFRICA", "P3", "CURATED", "NATIONAL"],
