...
describe("USPTO TSDR Web acquisition", () => {
  it("parses the three governed official surfaces", () => {
    ...
    expect(
      parseUsptoTsdrWebTarget("https://tsdr.uspto.gov/documentviewer?caseId=sn90817045"),
  ...
  it("rejects cross-serial and alternate-origin jobs", async () => {
    ...
    expect(() => parseUsptoTsdrWebTarget("https://example.test/statusview/sn90817045")).toThrow(
